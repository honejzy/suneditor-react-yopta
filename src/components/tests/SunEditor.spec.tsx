...
import suneditor from "suneditor-yoptatech";
import { fireEvent, render } from "@testing-library/react";
import SunEditor from "../SunEditor";
import { events, uploadBeforeEvents } from "../../data/events";

jest.mock("suneditor-yoptatech", () => ({
  __esModule: true,
  default: {
    create: (t: HTMLTextAreaElement) => {
      const txtArea = t;

      txtArea.dataset.testid = "suneditor-yoptatech";
...
jest.mock("suneditor-yoptatech/src/plugins", () => ({
  default: [],
}));
...
describe("<SunEditor />", () => {
  ...
  describe("Initialization", () => {
    it("should create suneditor-yoptatech", () => {
    ...
    it("should should set lang from suneditor-yoptatech when string is used", () => {
      const createSpy = jest.spyOn(suneditor, "create");
